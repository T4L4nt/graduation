...
| **DiT** (Transformer) | Sequential residual stream | 表示层转变区 | blocks 11-21 单峰 | 无跨层 skip，漂移在特征表示转变最快的区域集中 |
...
| **架构兼容性** | 在 SD 1.5 / SDXL 的 UNet-based 扩散模型上验证 | 覆盖 **UNet、DiT、MM-DiT 及 Flow Matching** 等主流生成架构，验证跨范式泛化性 |
