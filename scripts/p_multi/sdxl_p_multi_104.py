"""
SDXL P-multi@104 — Definition 1 compliant multi-timestep protocol.
...
print(f"SDXL P-multi@104: {len(IMAGES)} images, {NUM_STEPS} DDIM steps")
pipe = StableDiffusionXLPipeline.from_pretrained(
    "stabilityai/stable-diffusion-xl-base-1.0", torch_dtype=DTYPE, local_files_only=True).to(DEVICE)
...
for img_path in tqdm(IMAGES, desc="SDXL P-multi@104"):
    nm = img_path.stem
    try:
...
print(f"  Old P-t0@104: pp=0.964 (U2.R2), conc=0.552, sp=0.490  [loose check]")
