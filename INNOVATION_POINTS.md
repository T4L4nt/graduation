...
**FLUX vs HunyuanDiT Pearson r=0.727（同 Transformer backbone）> FLUX vs SD 1.5 r=0.486（不同 backbone）**——backbone attention 结构决定漂移模式，范式影响次要。这些指纹可以用架构拓扑来解释。
...
| # | 任务 | 当前 |
|---|------|------|
| 1 | SDXL 漂移 + 校正扩展到 19 图 | ✅ 22 图, Δ=+5.37 |
